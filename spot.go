...
// func (p *Client) SpotHistoryKline(symbol, interval string) (swaps *SpotsInfoResponse, err error) {
// 	params := make(map[string]string)
// 	params["symbol"] = strings.ToUpper(symbol)
// 	params["interval"] = interval

// 	res, err := p.sendRequest("spot", http.MethodGet, "/spot/quote/v1/kline", nil, nil, false)
// 	if err != nil {
// 		return nil, err
// 	}
// 	// in Close()
